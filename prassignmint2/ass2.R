## The functions here illustrate the use of <<- operator, and lexical scoping
## in general. The idea of lexical scoping is that the function comes together
## with its environment, also referred to as function closure.
